...
pub static PIPER_VOICES: phf::Map<&'static str, phf::Map<&'static str, PiperVoice<'static>>> = phf::phf_map! {
	"ar_JO" => phf::phf_map! {
		"Kareem - Low" => PiperVoice {
	...
	"cy_GB" => phf::phf_map! {
		...
		"Gwryw Gogleddol - Medium" => PiperVoice {
	...
	"de_DE" => phf::phf_map! {
		...
		"Thorsten Emotional - Medium" => PiperVoice {
	...
	"en_GB" => phf::phf_map! {
		...
		"Northern English Male - Medium" => PiperVoice {
		...
		"Southern English Female - Low" => PiperVoice {
	...
	"en_US" => phf::phf_map! {
		...
		"Reza Ibrahim - Medium" => PiperVoice {
	...
	"sr_RS" => phf::phf_map! {
		"Serbski Institut - Medium" => PiperVoice {
	...
	"uk_UA" => phf::phf_map! {
		...
		"Ukrainian TTS - Medium" => PiperVoice {
	...
	"vi_VN" => phf::phf_map! {
		"25 Hours Single - Low" => PiperVoice {
